    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '420px', padding: '24px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <h1 style={{ fontSize: '22px', fontWeight: 800, letterSpacing: '0.1em', margin: '0 0 6px', color: '#E8E8F0' }}>
            МОДУЛИ
          </h1>
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ fontSize: '10px', color: '#374151', marginTop: '6px', textAlign: 'center', lineHeight: 1.5 }}>
              После авторизации ВКонтакте вам придёт код подтверждения в МАКС
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '11px', color: '#6B7280', lineHeight: 1.6, marginBottom: '10px' }}>
              Инвестирование в объекты осуществляется через экосистему Telegram в TON-коинах.
              После авторизации ваш номер МИ привязывается к Telegram-боту.
            </div>
