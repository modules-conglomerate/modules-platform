...
export function MapSection({ objects }: Props) {
  ...
  return (
    <div style={{ background: '#12121A', border: '1px solid #1E1E2E', borderRadius: '8px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          {['all', 'construction', 'active', 'planning'].map(function(key) {
            const labels: Record<string, string> = {
              all: 'ВСЕ ОБЪЕКТЫ',
              construction: 'СТРОЯТСЯ',
              active: 'ДЕЙСТВУЮЩИЕ',
              planning: 'ПРОЕКТИРУЮТСЯ',
            }
            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: isActive ? '#C9A84C' : 'rgba(255,255,255,0.02)',
          ...
          <button
            onClick={function() { setMapHeight(DEFAULT_H) }}
            title="Сбросить высоту"
            style={{
              padding: '6px 8px', fontSize: '11px', background: 'transparent',
      ...
      <div style={{ position: 'relative', height: mapHeight + 'px', overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          {[
            { key: 'construction', label: 'Строится',      color: '#C9A84C' },
            { key: 'active',       label: 'Действует',     color: '#00D4AA' },
            { key: 'planning',     label: 'Проектируется', color: '#5B8CFF' },
          ].map(function(item) {
            return (
        ...
        <div style={{
          ...
          background: 'rgba(10,10,15,0.7)', border: '1px solid #1E1E2E',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '6px' }}>
              <button
                ...
                style={{
                  flex: 1, padding: '8px', background: selColor,
              ...
              <button
                ...
                style={{
                  ...
                  border: '1px solid #1E1E2E', borderRadius: '4px', cursor: 'pointer', fontSize: '13px',
                }}
              >
                ✕
              </button>
      ...
      <div
        ...
        style={{
          ...
          background: dragging ? '#1A1A2E' : '#0D0D14',
          borderTop: '1px solid ' + (dragging ? '#C9A84C44' : '#1E1E2E'),
          borderBottom: '1px solid ' + (dragging ? '#C9A84C44' : '#1E1E2E'),
          cursor: 'ns-resize',
          userSelect: 'none',
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '3px' }}>
          <div style={{ width: '32px', height: '1.5px', background: dragging ? '#C9A84C' : '#2A2A3E', borderRadius: '1px', transition: 'background 0.15s' }} />
          <div style={{ width: '32px', height: '1.5px', background: dragging ? '#C9A84C' : '#2A2A3E', borderRadius: '1px', transition: 'background 0.15s' }} />
          <div style={{ width: '32px', height: '1.5px', background: dragging ? '#C9A84C' : '#2A2A3E', borderRadius: '1px', transition: 'background 0.15s' }} />
        </div>
      </div>
